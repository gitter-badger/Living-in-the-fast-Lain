...
init -1 python hide:
    ...
    config.window_title = u"Living in the fast Lain"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "ILY Lain"
    config.version = "0.0"
    ...
    theme.roundrect(
        ...
        #CREDIT @MrDetonia
        mm_root = "resources/backgrounds/menu.png",
    ...
    config.main_menu_music = "resources/music/main_menu.ogg"
